/*
 * OTP input/output translation routines. derived from 
 * the Bellcore S/Key (tm) distribution.
 */
...
static uint32 extract __ARGS((char *s,int start,int length));
...
/*
 * convert standard dictionary endocing to binary   
        ...
        char *e;
{
	...
	if( (unsigned int)(p & 3) != extract(b, 64,2) )
		return -2;
